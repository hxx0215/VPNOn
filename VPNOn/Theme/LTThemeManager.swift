...
class LTThemeManager
{
    ...
    func activateTheme(theme : LTTheme)
    {
        ...
        UINavigationBar.appearance().titleTextAttributes = [NSForegroundColorAttributeName : theme.textColor]//NSDictionary(objects: [theme.textColor], forKeys: [NSForegroundColorAttributeName]) //as! [NSString : AnyObject]
